...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		<span class="screen-reader-text"><?php esc_html_e( 'Search for:','the-pet-clinic' ); ?></span>
	...
	<button type="submit" class="search-submit" role="tab"><?php echo esc_html_x( 'Search', 'submit button', 'the-pet-clinic' ); ?></button>
</form>